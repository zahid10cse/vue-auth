              ...
              <div class="card-body px-lg-5 py-lg-5">
                ...
                <form role="form" @submit.prevent="submitForm">
                  <div class="form-group mb-3">
                    ...
                    >
                      <div class="input-group-prepend" :class="{ error: v$.login.username.$errors.length }">
                    ...
                    <div class="input-errors" v-for="error of v$.login.username.$errors" :key="error.$uid">
...
import { profile } from '@/api/employee'
...
export default {
  ...
  methods: {
    async submitForm () {
      ...
      if (result) {
        axios
          .post(`${url}user/login/`, this.login)
          .then(response => {
